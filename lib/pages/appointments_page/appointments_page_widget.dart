...
import 'appointments_page_model.dart';
export 'appointments_page_model.dart';
...
class _AppointmentsPageWidgetState extends State<AppointmentsPageWidget> {
  late AppointmentsPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AppointmentsPageModel());
  }
                  ...
                  child: StreamBuilder<List<AppointmentsRecord>>(
                    stream: queryAppointmentsRecord(
                      queryBuilder: (appointmentsRecord) =>
                          appointmentsRecord.orderBy('day'),
                    ),
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                context.pushNamed(
                                  'AppointmentDetail',
                                  queryParameters: {
                                    'appointmentDocRef': serializeParam(
